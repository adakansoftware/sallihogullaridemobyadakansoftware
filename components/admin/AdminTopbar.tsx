...
export function AdminTopbar({ settings, unreadCount }: { settings: SiteSettings; unreadCount: number }) {
  return (
    <div className="industrial-border sticky top-0 z-20 min-w-0 rounded-[28px] bg-black/45 px-5 py-4 backdrop-blur-xl">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/" className="btn-ghost-premium inline-flex h-[58px] items-center justify-center px-5">
            Siteyi Gör
          </Link>
        </div>
      </div>
