...
const defaultSettings: SiteSettings = {
  ...
  serviceArea: 'Gaziantep merkezli, Türkiye geneli operasyon',
  ...
  heroTitle: 'Güçlü ekipman, zamanında operasyon, disiplinli saha yönetimi',
  heroDescription: 'Hafriyat, damperli nakliyat, lowbed taşıma ve iş makinesi operasyonlarında profesyonel saha gücü.',
  quoteNotice: 'Fiyatlandırma ve operasyon planlaması için teklif talebi bırakabilirsiniz.',
}
